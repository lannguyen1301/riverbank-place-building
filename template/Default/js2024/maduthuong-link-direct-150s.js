{
// tạm thời tắt tính năng chỉ cho tạo 1 mã trong khung giờ để anh em trải nghiệm trước 
document.addEventListener("DOMContentLoaded", function() {
    // Mini Game dưới button Readmore
    ...
    if (targetDiv) {
        ...
        var targetDiv_footer = document.getElementById("tfuser");
        if(targetDiv_footer) {
            targetDiv_footer.innerHTML = '<div class="" style="text-align: center !important; margin: 0px;"> <span class="btnMaDuThuong_footer back-top-maduthuong" id="maduthuong">Mini Game</span> </div>';
        }
    }
});
...
function startCountdown() {
    ...
    let countdown = 5; // Thời gian đếm ngược từ 150 giây
